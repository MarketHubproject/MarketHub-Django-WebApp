...
class ProductModelTest(TestCase):
    ...
    def test_product_category_choices(self):
        ...
        valid_categories = ['electronics', 'fashion', 'books', 'home', 'other']
    ...
    def test_product_filtering_by_category(self):
        ...
        self.assertEqual(fashion.count(), 1)
...
class ProductIntegrationTest(TestCase):
    def setUp(self):
        self.products_data = [
            ...
            {'name': 'T-Shirt', 'price': Decimal('29.99'), 'category': 'fashion'},
            {'name': 'Novel', 'price': Decimal('14.99'), 'category': 'books'},
            {'name': 'Coffee Mug', 'price': Decimal('12.99'), 'category': 'home'},
            {'name': 'Gift Card', 'price': Decimal('50.00'), 'category': 'other'},
        ]
