...
import OrderHistoryScreenComponent from "./OrderHistoryScreen";
import OrderDetailsScreenComponent from "./OrderDetailsScreen";
import ProductSearchScreenComponent from "./ProductSearchScreen";
import ProductCategoriesScreenComponent from "./ProductCategoriesScreen";
import CheckoutScreenComponent from "./CheckoutScreen";
import OrderConfirmationScreenComponent from "./OrderConfirmationScreen";
...
export const OrderHistoryScreen = OrderHistoryScreenComponent;
export const OrderDetailsScreen = OrderDetailsScreenComponent;
export const ProductSearchScreen = ProductSearchScreenComponent;
export const ProductCategoriesScreen = ProductCategoriesScreenComponent;
export const CheckoutScreen = CheckoutScreenComponent;
export const OrderConfirmationScreen = OrderConfirmationScreenComponent;
