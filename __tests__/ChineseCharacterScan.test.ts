...
describe('Chinese Character Scan', () => {
   ...
   */
  const scanFileForChineseCharacters = (filePath: string): { hasChineseChars: boolean; matches: RegExpMatchArray[] } => {
    try {
  ...
  describe('Source Files Chinese Character Scan', () => {
    ...
    it('should not contain Chinese characters in any source files', () => {
      ...
      if (filesWithChineseChars.length > 0) {
        ...
        throw new Error(`Found Chinese characters in ${filesWithChineseChars.length} file(s):${errorMessage}`);
      }
  ...
  describe('I18n Translation Files', () => {
    ...
    it('should not contain Chinese characters in translation files', () => {
      ...
      if (filesWithChineseChars.length > 0) {
        ...
        throw new Error(`Found Chinese characters in translation file(s):${errorMessage}`);
      }
  ...
  describe('Test Coverage', () => {
    ...
    it('should properly exclude certain files from scanning', () => {
      ...
      const shouldExclude = excludeFiles.some(exclude => testFilePath.includes(exclude));
